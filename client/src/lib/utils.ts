...
export function buttonClassName(
  ...
  return cn(
    'inline-flex items-center justify-center rounded-s font-body font-normal leading-[26px] transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-content-brand-eb disabled:cursor-not-allowed disabled:opacity-50',
